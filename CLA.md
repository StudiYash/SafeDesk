...
Thank you for your interest in contributing to the SafeDesk project!

By making a contribution to this project, you agree to the following terms:

1. **You retain ownership of your contribution.** You retain all rights, titles, and interests in and to your contributions. This agreement does not transfer ownership of your contributions to the SafeDesk project or its maintainers.

2. **You grant us a license to use your contribution.** You hereby grant SafeDesk and its maintainers a perpetual, worldwide, non-exclusive, royalty-free license to use, reproduce, modify, distribute, sublicense, and incorporate your contributions into the project under the same license as the project (Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License).
...
5. **Contribution includes any code, documentation, or other materials you provide.** This CLA applies to all contributions you make to the SafeDesk project, including but not limited to code, documentation, and any other materials.
...
Thank you for contributing to SafeDesk!